...
RSpec.describe CitizensController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested citizen as @citizen" do
      citizen = Citizen.create! valid_attributes
      get :show, {:id => citizen.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested citizen as @citizen" do
      citizen = Citizen.create! valid_attributes
      get :edit, {:id => citizen.to_param}, valid_session
      expect(assigns(:citizen)).to eq(citizen)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Citizen" do
        expect {
          post :create, {:citizen => valid_attributes}, valid_session
        }.to change(Citizen, :count).by(1)
      end

      it "assigns a newly created citizen as @citizen" do
        post :create, {:citizen => valid_attributes}, valid_session
        expect(assigns(:citizen)).to be_a(Citizen)
        expect(assigns(:citizen)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved citizen as @citizen" do
        post :create, {:citizen => invalid_attributes}, valid_session
        expect(assigns(:citizen)).to be_a_new(Citizen)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested citizen" do
        citizen = Citizen.create! valid_attributes
        put :update, {:id => citizen.to_param, :citizen => new_attributes}, valid_session
        citizen.reload
      ...
      it "assigns the requested citizen as @citizen" do
        citizen = Citizen.create! valid_attributes
        put :update, {:id => citizen.to_param, :citizen => valid_attributes}, valid_session
        expect(assigns(:citizen)).to eq(citizen)
      end
    ...
    context "with invalid params" do
      it "assigns the citizen as @citizen" do
        citizen = Citizen.create! valid_attributes
        put :update, {:id => citizen.to_param, :citizen => invalid_attributes}, valid_session
        expect(assigns(:citizen)).to eq(citizen)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested citizen" do
      citizen = Citizen.create! valid_attributes
      expect {
        delete :destroy, {:id => citizen.to_param}, valid_session
      }.to change(Citizen, :count).by(-1)
    end
