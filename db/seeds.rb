if User.count == 0
  ...
  100.times do |n|
    ...
    family_relation = FamilyRelation.new(realname: "父亲大人", relation_name: "fahter", family_related_id: archive.family_related_id)
    family_relation.save(:validate => false)

    family_relation = FamilyRelation.new(realname: "母亲大人", relation_name: "mohter", family_related_id: archive.family_related_id)
    family_relation.save(:validate => false)

    family_relation = FamilyRelation.new(realname: "哥哥", relation_name: "old-brother", family_related_id: archive.family_related_id)
    family_relation.save(:validate => false)

    family_relation = FamilyRelation.new(realname: "弟弟", relation_name: "young-brother", family_related_id: archive.family_related_id)
    family_relation.save(:validate => false)
